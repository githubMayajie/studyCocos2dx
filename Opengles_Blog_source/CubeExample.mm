 ...
 ***********************************************************************************************************
 *
 *	If you are studying this file, try start by the end. This file pipeline happens up-side down.
 *	So the first function which will be called here is the last function in this file, the "initOpenGL()".
 *	
 *	Good Luck!
 */
...
void drawScene(void)
{
	...
	matrixRotateX(- rotation * .25, matRotateX);
	matrixRotateY(rotation, matRotateY);
