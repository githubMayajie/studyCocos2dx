...
public class GLESView extends GLSurfaceView {
    private static final String TAG = GLESView.class.getSimpleName();
    ...
    protected static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        public EGLConfig selectConfig(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            Log.d(TAG, "selectConfig: " + configs.length);
            for (EGLConfig config : configs) {
                printConfig(egl, display, config);
            }

            for (EGLConfig config : configs) {
                int d = getConfigAttrib(egl, display, config,
                ...
                int r = getConfigAttrib(egl, display, config,
                        EGL10.EGL_RED_SIZE, 0);
                int g = getConfigAttrib(egl, display, config,
                        EGL10.EGL_GREEN_SIZE, 0);
                int b = getConfigAttrib(egl, display, config,
                        EGL10.EGL_BLUE_SIZE, 0);
                int a = getConfigAttrib(egl, display, config,
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            Log.d(TAG, "onSurfaceCreated: " + gl.glGetString(GL10.GL_VERSION));
        }
